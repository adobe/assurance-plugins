...
/**
 * Calculate event statistics for a set of events
 */
export function calculateEventStatistics(events: LiveActivityEvent[]): EventStatistics {
...
/**
 * Calculate time range for a set of events
 */
export function calculateTimeRange(events: LiveActivityEvent[]): TimeRange | null {

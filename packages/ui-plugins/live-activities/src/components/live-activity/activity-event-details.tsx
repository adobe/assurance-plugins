...
import { EventTableWithDetails, defaultColumns } from '@assurance/event-table';
...
function ActivityEventDetails({ activity }: Readonly<ActivityEventDetailsProps>) {
  ...
  const {
    activityNavigation: { selectedEventId }
  } = usePluginState();
      ...
      <Flex direction="column" gap="size-200" maxHeight="50vh">
                      ...
                      <View padding="size-200">
                        <table style={{ width: '100%', borderCollapse: 'collapse' }}>
                          <tbody>
                            ...
                            />
                            <InfoField label="Duration" value={`${timeRange.duration} minutes`} />
                          </tbody>
                        </table>
                      </View>
                    </Card>
        ...
        <Flex direction="column" gap="size-200">
          ...
          >
            ...
            <Item key="content-update">Content Updates ({eventStats.contentUpdate})</Item>
            <Item key="token-update">Token Updates ({eventStats.tokenUpdate})</Item>
            ...
            <Item key="dismissed">Dismissed Events ({eventStats.dismissed})</Item>
          </ActionGroup>
        </Flex>
          ...
          <EventTableWithDetails<LiveActivityEvent>
            columns={
              [
                ...
                eventNameColumn,
                eventTypeColumn
              ] as ColumnDef<LiveActivityEvent>[]
            }
            data={filteredEvents}

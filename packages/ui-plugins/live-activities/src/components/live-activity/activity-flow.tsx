...
import { ActionGroup, Divider, Flex, Heading, Item, Text, View, Well } from '@adobe/react-spectrum';
...
function ActivityFlow({ activity }: ActivityFlowProps) {
  ...
  const flowEvents: FlowEvent[] = useMemo(() => {
    ...
    const allEvents = [...(activity.events || []), ...(activity.updateEvents || [])];
          ...
          <Flex direction="column" gap="size-200">
            ...
            <View>
              ...
              {flowEvents.length === 0 ? (
                              ...
                              <Flex direction="column" gap="size-100">
                                ...
                                {event.type === 'content-update' && event.contentState && (
                                  <Well>
                                    ...
                                    <Text UNSAFE_className={classNames('contentStateText')}>
                                ...
                                {event.type === 'token-update' && event.token && (
                                  <Well>
                                    ...
                                    <Text UNSAFE_className={classNames('tokenText')}>
                                      {event.token}
                                    </Text>
                                  </Well>
                                )}
                ...
                // Cards View
                <View UNSAFE_className={classNames('cardsGrid')}>
                  {flowEvents
                    .map(event => (
                      <Card key={event.id}>
                        <View padding="size-200" marginBottom="size-200">
                          <Flex direction="column" gap="size-100">
                            <Flex direction="row" alignItems="center" gap="size-100">
                              ...
                              <Text UNSAFE_style={{ fontWeight: 'bold' }}>{event.title}</Text>
                            </Flex>
                            <Text UNSAFE_className={classNames('eventTimestamp')}>

...
import { EventContext, NavigationContext, SelectedEventContext, SettingsContext, ValidationContext, } from "./Contexts";
...
function checkContext(context, check = true) {
...
export const useFilteredEvents = (config = {
    sorted: true,
    filtered: false,
    hideLogs: false,
    ignoreFilters: [],

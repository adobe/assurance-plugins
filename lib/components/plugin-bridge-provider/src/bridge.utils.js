...
export const flushConnection = (namespace, context) => window.pluginBridge.flushConnection(namespace, context);
...
export const sendCommand = command => window.pluginBridge.sendCommand(command);
export const uploadPlugin = contents => window.pluginBridge.uploadPlugin(contents);

...
const App = () => {
    return (React.createElement(Provider, { theme: defaultTheme, colorScheme: "light" },
        React.createElement(PluginBridgeProvider, null,
            ...
            React.createElement(ValidationSummaryItem, { namespace: 'aep-consent-configuration' }),
            React.createElement(ValidationSummaryItem, { namespace: 'aep-consent-registered' }),
            React.createElement(ValidationSummaryItem, { namespace: 'aep-consent-status' }))));
};
export default App;
